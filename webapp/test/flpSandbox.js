		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5 Calendar",
									"targetURL": "#sapui5calendar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5calendar-display": {
								"semanticObject": "sapui5calendar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5calendar",
									"url": sap.ui.require.toUrl("sapui5calendar")
								}
							}
						}
					}
